...
public class Varriable_01 {
	public static void main(String[] args) {
		...
		/*
		 * 위 다섯가지의 명령코드에서 숫자 30과 40 그리고 연산결과는 각자 기억장치 어딘가에 
		 * (임시)보관 되어 연산 수행이 이루어 진다.
		 * 
		 * 그런데, 똑같은 30이라는 숫자가 5번 사용되었지만 이 30은 5개의 기억장소를 사용한다.
		 * 또한 5번의 40도 5개의 기억장소를 사용하며, 결과를 저장하는 기억장소도 마찬가지 이다
		 * 
		 * 불과 5번의 명령 수행을 위하여 기억장치를 15개 낭비하게 된다.
		 * 
		 * 30과 40이라는 두 숫자를 어떤 지정된 기억장소에 보관해 두고 연산할때 그값을 참조하여
		 * 연산을 하도록 한다면 기억 장치를 효율적으로 사용할수 있을 것이다.
		 * 
