...
public class Controller_10 {
	...
	/*
	 * 0~100 까지 중의 임의의 정수 5개를 만들어서 그 수가 짝수인지 아닌지를 출력
	 */
	...
	public static void main(String[] args) {
		...
		if(num2 % 2 == 0) {
			...
			System.out.println(num2 + "는 짝수가 아님");
		}
		
		if(num3 % 2 == 0) {
			System.out.println(num3 + "는 짝수");
		} else {
			System.out.println(num3 + "는 짝수가 아님");
		}
		
		if(num4 % 2 == 0) {
			System.out.println(num4 + "는 짝수");
		} else {
			System.out.println(num4 + "는 짝수가 아님");
		}
		
		if(num5 % 2 == 0) {
			System.out.println(num5 + "는 짝수");
		} else {
			System.out.println(num5 + "는 짝수가 아님");
		}
