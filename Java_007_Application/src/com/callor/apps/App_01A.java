...
public class App_01A {
	...
	public static void main(String[] args) {
		...
		// for() 반복문이 모두 완료되었거나 중간에 
		// break를 만나서 중단되었거나 
		
		// setting 되거나 그렇지 않은 경우를 판단하여 결과를 출력하기
		if (notPrime) { // notPrime = true 인경우
			// num2가 소수가 아닌경우
		 ...
		 * 1과2의 경우에 num변수의 상태가 다르다
		 * 
		 * num 변수의 값은 조건문의 최대값과 같다
		 * 1번의 경우 num 값은 num2 보다 항상 작다
		 * 2번의 경우 num 값은 num2 보다 크거나 같다
		 * 
		 * if(num == num2) 라는 비교문을 사용하는 것 보단 
		 * if(num<num2) 조건문을 사용하는것이 논리적인 문제를 최소화할수 있다.
		 * 		 
		 * 
		 * */
