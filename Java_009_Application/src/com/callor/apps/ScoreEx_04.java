 ...
 * 객체가 만들어진다 = 기억장치 어딘가에 저장소가 만들어진다. 
 * 						마치 변수처럼
 * 객체 연결 연산자(점 연산자)가 있다.
 * 객체는 객체 자체만으로 어떤 역할을 수행하지 않는다.
...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 기본 변수 선언 키워드(primitive varriable key world)
		 * int, long, double, float, boolean, char
		 * 
		 * 기본 변수와 사용법이 같은 클래스
		 * wrapper class : 기본 변수를 감싸고 기능을 확장한다 라는 뜻
		...
		// method를 호출하여 return 한 결과를 또다른 method에 매개변수로 전달하는 코드의 예
		System.out.println(Arrays.toString("Republic of Korea".split(" ")));
		
		
		System.out.println(Integer.valueOf("30") + Integer.valueOf("48"));
