...
public class Value_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * -1 입력했을때 코드를 종료하고 싶다.
		 * 코드를 종료하고 싶다 이러한 코드를 작성했는데 이 경우는 num1에
		 * -1 값이 어떤 의미없는 값이기 때문에 가능한 코드이다. 
		 * 
		 * 만약 -1이 실제 값으로 존재하는 필요한 값이라면 이러한 코드는 사용이
		 * 어려워진다.
		 * 
	...
	// 0 ~ 99까지 난수 1개를 생성하여 return 하는 method
