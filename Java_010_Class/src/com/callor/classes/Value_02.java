...
/*
 * null 값
 * 	프로그래밍, 정보처리에서는 어떤 항목의 데이터가 있는가 없는가를 판단해야 하는 경우가 있다.
 *	
...
//		System.out.println(num);
		...
		// 키보드에서 문자열을 입력하고 Enter를 누르면 값이 str 변수에 다음 코드가 실행
		// 그냥 Enter만 눌러도 입력을 종료하고 다음 코드가 실행된다.
		System.out.print("숫자1>> ");
		String str1 = scan.nextLine();
		if( str1 == "") { // "" 문자열 변수의 null 값과 유사한 성격을 갖는 값
