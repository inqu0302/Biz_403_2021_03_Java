...
/*
 *  mian() method에서 같은 클래스 내의 다른 method 를 호출하여 코드를 실행하려면
 ...
 */
	 ...
	 * divid() method에 2개의 정수를 매개변수로 전달하고 전달한 숫자가 0이아니면 나눗셈 연산을
	 * 하여 return 하고 전달한 숫자가 한개라도 0이면 나눗셈 연산을 수행하지 않고 null값을 return 
	 */
