...
public class MethodService {
	...
	// 변수는 같은 { } 구역내에서는 같은 이름으로 절대 중복선언 할 수 없다.
	int num1;
	int num2;
	
	// method는 같은 클래스의 { } 구역 내에서는 같은 이름으로 원칙적으로 중복선언 할 수 없다.
	// 예외 상황에서는 가능
	//	1. method의 매개변수의 있고 없고 차이
	//	2. 매개변수의 개수 차이
	//	3. 매개변수의 type의 차이
	...
	/*
	 * method 코드를 작성할때 매개변수를 선언하면 이 method를 호출할때 반드시 매개변수에 해당하는
	 * 값을 전달해야 한다.
