...
public class NumberServiceV1 {
	...
	/*
	 * 두 정수의 덧셈, 두 실수의 덧셈, 두개의 문자열 연결 수행하는 코드를
	 * 클래스를 만들고 분리하여 작성하고 있다.
	 * 
	 * 이러한 코드를 작성할때 각각의 method이름을 고유하게 작성
	 * 	(구조적, 모듈화 프로그래밍 시절)
	 * 
	 * 객체지향 프로그래밍 시절에는 매개변수의 타입을 달리하여 같은 이름을
	 * 사용할 수 있다.
	 * 
	 */
	...
	/*
	 * 객체지향 프로그래밍에서는 한 클래스내에서 같은 이름의 method를
	 * 	중복 선언하여 작성할 수 있다.
	 * 단, 매개변수의 개수를 달리하거나 매개변수의 type을 달리하는 
	 * 	방식을 method를 선언해야 한다.
	 */
