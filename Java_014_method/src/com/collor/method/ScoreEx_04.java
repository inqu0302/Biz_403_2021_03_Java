...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		 ...
		 * 저장소를 만들고 저장소들의 첫번째 주소를 stack 메모리에 저장하고 
		...
		/*
		 * scoreVO 객체의 kor 변수의 값을 읽어서 intKor의 변수에
		 * 저장해 달라
		 * 
		 * 1. stack 메모리에 있는 scoreVO 변수를 찾는다.
		 * 2. scoreVO변수에 저장된 주소를 읽기
		 * 3. 그 주소에 해당하는 Heap 메모리를 찾고
		 * 4. Heap 메모리의 kor 변수에서 값을 읽어서
		 * 5. intKor 변수에 저장
		 */
