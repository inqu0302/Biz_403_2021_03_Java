...
public class ScoreServiceImplV2Ex extends ScoreServiceImplV2{
	...
	// 과목명, 과목점수가 담긴 배열에 대한 위치를 숫자가아닌
	// 명명된 이름으로 사용하기 위하여 배열의 index값을 상수로 선언
	...
	public void inputScore() {
		...
		while(true) {
			...
			System.out.println(strNum + "학색의 이름 입력(QUIT : 입력중단");
		...
		// 각 과목의 점수를 별도로 입력받아 변수에 저장하기 귀찮아
		// 창조적 게으름을 피워보기
		
		// 입력받을 과목명을 변수로 선언
//		String [] subject = {"국어", "영어", "수학"};
		// subject 배열을 멤버영역으로 이동 subjectList로
		// 	 점수를 입력하는 곳에서 사용하기 위하여 과목명을 담을
		//	 배열을 선언 했는데 다른 method에서도 사용하기 위해
		//	 클래스 영역으로 이동하였다.
...
//		Integer [] intScore = new Integer[ subject.length];
	...
	public void printScroe() {
		...
		System.out.println("빛나라 고교 성직리스트 2021");
